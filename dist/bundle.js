...
var _musicPlayer = __webpack_require__(27);

var _musicPlayer2 = _interopRequireDefault(_musicPlayer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_musicPlayer2.default, null), document.getElementById('root'));
...
var Home = function (_React$Component) {
  ...
  function Home() {
    ...
    _this.setDefaultMusic = _this.setDefaultMusic.bind(_this);
    _this.defaultMusicValue = _this.defaultMusicValue.bind(_this);
    return _this;
  }
  ...
  _createClass(Home, [{
    ...
    key: 'setDefaultMusic',
    value: function setDefaultMusic() {
      var _this2 = this;

      var defaultState = this.state.sliderData;
      this.state.musicList.map(function (data) {
        return _this2.defaultMusicValue(data);
      });
    }
  }, {
    key: 'defaultMusicValue',
    value: function defaultMusicValue(music) {
      ...
      switch (music) {
        case 'preset':
          ...
          break;
        case 'pop':
          defaultValue = [60, 120, 180, 30, 240];
          break;
        case 'bass':
          defaultValue = [128, 150, 40, 100, 220];
          break;
      }
      if (music) {
        this.setState(_defineProperty({}, music, defaultValue), this.setSliderColor);
      }
    }
  }, {
    key: 'handleSelect',
    value: function handleSelect(event) {
      ...
      var changeMusic = Object.assign({}, { value: event.target.value });
